...
export const PostNewMessage = () => {
    ...
    async function sumbitNewQuestion() {
        ...
        if(authState?.isAuthenticated && title !== '' && question !== ''){
          ...
          const sumbitNewQuestionResponse = await fetch(url, requestOptions);
          if(!sumbitNewQuestionResponse.ok){
            ...
            <div className="card-body">
                <form method='POST'>
                    ...
                    <div className="alert alert-danger" role="alert">
                        ...
                        <div>
                            <button type="button" className="btn btn-primary mt-3" onClick={sumbitNewQuestion}>
                                Sumbit Question
                            </button>
                        </div>
                </form>

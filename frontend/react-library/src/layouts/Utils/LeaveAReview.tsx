...
export const LeaveAReview: React.FC<{sumbitReview: any}> = (props) => {
    ...
    return(
        <div className="dropdown" style={{cursor: `pointer`}}>
            ...
            <ul id='sumbitReviewRating' className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <form method='POST' action="#">
                ...
                <div className="mb-3">
                    ...
                    <textarea className="form-control" id="sumbitReviewDescription" placeholder="Optional"
                    rows={3} onChange={e => setReviewDescription(e.target.value)}>
                    </textarea>
                </div>

                <div>
                    <button type="button"  onClick={() => props.sumbitReview(starInput, reviewDescription)} className="btn btn-primary mt-3">Sumbit review</button>
                </div>
            </form>
}
        </div>

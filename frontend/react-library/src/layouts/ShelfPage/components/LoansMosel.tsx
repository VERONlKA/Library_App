...
renewLoan: any}> = (props) => {
    return (
        ...
        `modal${props.shelfCurrentLoan.book.id}`} data-bs-backdrop='static' dta-bs-keyboard='false'
                            ...
                            <div className="mt-3">
                                ...
                                {props.shelfCurrentLoan.daysLeft > 0 &&
                                        <p className="text-secondary">
                                            Due to {props.shelfCurrentLoan.daysLeft} days.
                                            </p>}
                                            {props.shelfCurrentLoan.daysLeft === 0 &&
                                            <p className="text-sucess">
                                                ...
                                                <p className="text-danger">
                                                    ...
                                                    <div className="list-group mt-3">
                                                        ...
                                                        :
                                                        () => props.shelfCurrentLoan.book.id} data-bs-dismiss='modal'
                                                        className={
                                                            props.shelfCurrentLoan.daysLeft < 0 ?
                                                            'list-group-item list-group-item-action inactivateLink':

...
import { LoansModal } from "./LoansMosel";
...
export const Loans = () => {
    ...
    const[isLoadingUserLoans, setIsLoasingUserLoans] = useState(true);
                                ...
                                <div className="card-body">
                                    <div className="mt-3">
                                        ...
                                        <p className="text-secondary">
                                            Due to {shelfCurrentLoan.daysLeft} days.
                                            </p>}
                                            {shelfCurrentLoan.daysLeft === 0 &&
